...
Decision trees tend to be the method of choice for predictive modeling.A classification tree is used to predict qualitative data.We are using 5-fold cross validation resampling procedure to improve the model.
```{r echo=FALSE}
set.seed(modelSeed)
