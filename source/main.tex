...
#>       Variable       Count
#>       Sunshine 0.476666667
#>    Evaporation 0.433833333
#>       Cloud3pm 0.398000000
#>       Cloud9am 0.371666667
#>    Pressure3pm 0.099833333
#>    Pressure9am 0.099166667
#>    WindGustDir 0.068000000
#>     WindDir9am 0.067833333
#>  WindGustSpeed 0.067500000
#>     WindDir3pm 0.026666667
#>    Humidity3pm 0.026666667
#>        Temp3pm 0.020500000
#>   WindSpeed3pm 0.019166667
#>    Humidity9am 0.011333333
#>       Rainfall 0.009166667
#>   WindSpeed9am 0.009166667
#>      RainToday 0.009166667
#>        Temp9am 0.005666667
#>        MinTemp 0.004166667
#>        MaxTemp 0.002666667
#>           Date 0.000000000
...
#>          1   0.8220 0.3579  0.0075375 0.050475         
#>          2   0.8068 0.3694  0.0037996 0.016869         
#>          3   0.8268 0.4286  0.0122984 0.070036         
#>          4   0.8413 0.4893  0.0138904 0.062262         
#>          5   0.8405 0.4975  0.0041185 0.045392         
#>          6   0.8447 0.5092  0.0024217 0.043001         
#>          7   0.8460 0.5262  0.0035618 0.025266         
#>          8   0.8462 0.5361  0.0030817 0.021785         
#>          9   0.8457 0.5345  0.0036273 0.013533         
#>         10   0.8468 0.5368  0.0022905 0.007530         
#>         11   0.8477 0.5341  0.0037683 0.018350         
#>         12   0.8482 0.5386  0.0040639 0.014088        *
#>         13   0.8437 0.5297  0.0061410 0.016993         
#>         14   0.8442 0.5290  0.0035464 0.009578         
#>         15   0.8435 0.5293  0.0047030 0.012035         
#>         16   0.8448 0.5341  0.0042348 0.002200         
#>         17   0.8440 0.5306  0.0047032 0.011647         
#>         18   0.8433 0.5306  0.0027894 0.007575         
#>         19   0.8465 0.5359  0.0035306 0.010462         
#>         20   0.8472 0.5354  0.0009869 0.013526         
#>         21   0.8453 0.5306  0.0026765 0.008085         
#>         22   0.8480 0.5362  0.0038381 0.002994         
#> 
#> The top 5 variables (out of 12):
#>    Humidity3pm, Sunshine, WindGustSpeed, Pressure3pm, Rainfall
\end{Soutput}
\end{Schunk}
...
#>  [5] "Rainfall"      "Cloud3pm"      "Location"      "Pressure9am"  
#>  [9] "Humidity9am"   "RainToday"     "MinTemp"       "Temp3pm"
\end{Soutput}
\end{Schunk}
...
\begin{Schunk}
\begin{Sinput}
confusionMatrix(data = logRegModel.pred, testDataCopy$RainTomorrow)
\end{Sinput}
\begin{Soutput}
...
#>          Neg Pred Value : 0.5799          
#>              Prevalence : 0.7799          
#>          Detection Rate : 0.6498          
#>    Detection Prevalence : 0.6904          
...
\begin{Schunk}
\begin{Sinput}
rm(trainDataCopy, testDataCopy, fittedVal)
\end{Sinput}
\end{Schunk}
